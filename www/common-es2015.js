...
let Property = Property_1 = class Property extends parse__WEBPACK_IMPORTED_MODULE_2__["Object"] {
    constructor() {
        super('Property');
    }
    static getInstance() {
    ...
    load(params = {}) {
        return new Promise((resolve, reject) => {
            ...
            let query = new parse__WEBPACK_IMPORTED_MODULE_2__["Query"](Property_1);
            if (params.id) {
