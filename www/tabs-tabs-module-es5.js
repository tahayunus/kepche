        ...
        children: [
            {
                ...
                children: [
                    ...
                    {
                        path: 'address',
                        loadChildren: function () { return Promise.all(/*! import() | pages-address-address-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-address-address-module")]).then(__webpack_require__.bind(null, /*! ../pages/address/address.module */ "./src/app/pages/address/address.module.ts")).then(function (m) { return m.AddressPageModule; }); }
                    },
                    {
                        path: 'address/add',
                        loadChildren: function () { return Promise.all(/*! import() | pages-add-address-add-address-module */[__webpack_require__.e("default~pages-add-address-add-address-module~pages-place-add-place-add-module"), __webpack_require__.e("common"), __webpack_require__.e("pages-add-address-add-address-module")]).then(__webpack_require__.bind(null, /*! ../pages/add-address/add-address.module */ "./src/app/pages/add-address/add-address.module.ts")).then(function (m) { return m.AddAddressPageModule; }); }
                    },
                    {
                        path: 'search',
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        path: 'places/add',
                        canActivate: [_services_auth_guard_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
                        loadChildren: function () { return Promise.all(/*! import() | pages-place-add-place-add-module */[__webpack_require__.e("default~pages-add-address-add-address-module~pages-place-add-place-add-module"), __webpack_require__.e("pages-place-add-place-add-module")]).then(__webpack_require__.bind(null, /*! ../pages/place-add/place-add.module */ "./src/app/pages/place-add/place-add.module.ts")).then(function (m) { return m.PlaceAddPageModule; }); }
                    },
                    {
                        path: 'places/:id/reviews',
                        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-review-list-review-list-module */ "pages-review-list-review-list-module").then(__webpack_require__.bind(null, /*! ../pages/review-list/review-list.module */ "./src/app/pages/review-list/review-list.module.ts")).then(function (m) { return m.ReviewListPageModule; }); }
