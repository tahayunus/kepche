...
let PlaceMenuModalPage = class PlaceMenuModalPage extends _base_page_base_page__WEBPACK_IMPORTED_MODULE_4__["BasePage"] {
    ...
    getProduct() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.product = yield this.productService.loadOne(this.id);
...
let PlaceMenuPage = class PlaceMenuPage extends _base_page_base_page__WEBPACK_IMPORTED_MODULE_5__["BasePage"] {
    constructor(injector, productService, placeService) {
        super(injector);
        this.productService = productService;
    ...
    getProducts() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const place = new src_app_services_place_service__WEBPACK_IMPORTED_MODULE_2__["Place"]();
            place.id = this.getParams().id;
            this.products = yield this.productService.loadMenu(place);
    ...
    changeStatus(event, id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log(event);
            const product = new src_app_services_product__WEBPACK_IMPORTED_MODULE_3__["Product"]();
            product.id = id;
            if (event === true) {
                product.set('isActive', false);
                product.save();
                const trans = yield this.getTrans(['GOOD_JOB', 'PRODUCT_IS_DEACTIVE', 'OK']);
...
//# sourceMappingURL=default~pages-place-detail-place-detail-module~pages-place-menu-place-menu-module-es2015.js.map