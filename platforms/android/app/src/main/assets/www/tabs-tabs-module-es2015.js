        ...
        children: [
            {
                ...
                children: [
                    ...
                    {
                        path: 'address/add',
                        loadChildren: () => Promise.all(/*! import() | pages-add-address-add-address-module */[__webpack_require__.e("default~pages-add-address-add-address-module~pages-place-add-place-add-module~pages-place-detail-pla~98be4056"), __webpack_require__.e("default~pages-add-address-add-address-module~pages-place-add-place-add-module"), __webpack_require__.e("pages-add-address-add-address-module")]).then(__webpack_require__.bind(null, /*! ../pages/add-address/add-address.module */ "./src/app/pages/add-address/add-address.module.ts")).then(m => m.AddAddressPageModule)
                    },
                    {
                        path: 'search',
                    ...
                    {
                        path: 'places/:id/menu',
                        loadChildren: () => Promise.all(/*! import() | pages-place-menu-place-menu-module */[__webpack_require__.e("default~pages-add-address-add-address-module~pages-place-add-place-add-module~pages-place-detail-pla~98be4056"), __webpack_require__.e("default~pages-place-detail-place-detail-module~pages-place-menu-place-menu-module"), __webpack_require__.e("pages-place-menu-place-menu-module")]).then(__webpack_require__.bind(null, /*! ../pages/place-menu/place-menu.module */ "./src/app/pages/place-menu/place-menu.module.ts")).then(m => m.PlaceMenuPageModule)
                    },
                    {
                        path: 'places/:id/menu/:product/edit',
                        loadChildren: () => __webpack_require__.e(/*! import() | pages-product-edit-product-edit-module */ "pages-product-edit-product-edit-module").then(__webpack_require__.bind(null, /*! ../pages/product-edit/product-edit.module */ "./src/app/pages/product-edit/product-edit.module.ts")).then(m => m.ProductEditPageModule)
                    },
                ]
            },
            {
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        path: 'places/add',
                        canActivate: [_services_auth_guard_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
                        loadChildren: () => Promise.all(/*! import() | pages-place-add-place-add-module */[__webpack_require__.e("default~pages-add-address-add-address-module~pages-place-add-place-add-module~pages-place-detail-pla~98be4056"), __webpack_require__.e("default~pages-add-address-add-address-module~pages-place-add-place-add-module"), __webpack_require__.e("pages-place-add-place-add-module")]).then(__webpack_require__.bind(null, /*! ../pages/place-add/place-add.module */ "./src/app/pages/place-add/place-add.module.ts")).then(m => m.PlaceAddPageModule)
                    },
                    {
                        path: 'places/:id/reviews',
                        loadChildren: () => __webpack_require__.e(/*! import() | pages-review-list-review-list-module */ "pages-review-list-review-list-module").then(__webpack_require__.bind(null, /*! ../pages/review-list/review-list.module */ "./src/app/pages/review-list/review-list.module.ts")).then(m => m.ReviewListPageModule)
