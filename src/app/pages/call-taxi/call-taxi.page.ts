...
@Component({
  ...
  templateUrl: './call-taxi.page.html',
  styleUrls: ['./call-taxi.page.scss'],
  animations: [
    trigger('staggerIn', [
      transition('* => *', [
...
export class CallTaxiPage extends BasePage {
  ...
  async loadData() {
    try {
      const placeses = await this.placeService.loadTaxi(this.params);
